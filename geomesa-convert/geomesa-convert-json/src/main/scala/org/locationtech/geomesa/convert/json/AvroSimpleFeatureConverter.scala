...
class JsonSimpleFeatureConverterFactory extends SimpleFeatureConverterFactory[Array[Byte]] {
  ...
  override def buildConverter(targetSFT: SimpleFeatureType, conf: Config): SimpleFeatureConverter[Array[Byte]] = {
    ...
    new JsonSimpleFeatureConverter(avroSchema, reader, targetSFT, fields, idBuilder)
  }

}

class JsonSimpleFeatureConverter(avroSchema: Schema,
